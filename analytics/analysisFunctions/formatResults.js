...
export const formatResults = (resultsArray) => {
	...
	const freqDistOfFstDigit = `Ones (all | unique): ${resultsArray[21].ones[0]} (${resultsArray[21].ones[1]}%) | ${resultsArray[21].ones[2]} (${resultsArray[21].ones[3]}%) \nTwos (all | unique): ${resultsArray[21].twos[0]} (${resultsArray[21].twos[1]}%) | ${resultsArray[21].twos[2]} (${resultsArray[21].twos[3]}%) \nThrees (all | unique): ${resultsArray[21].threes[0]} (${resultsArray[21].threes[1]}%) | ${resultsArray[21].threes[2]} (${resultsArray[21].threes[3]}%) \nFours (all | unique): ${resultsArray[21].fours[0]} (${resultsArray[21].fours[1]}%) | ${resultsArray[21].fours[2]} (${resultsArray[21].fours[3]}%) \nFives (all | unique): ${resultsArray[21].fives[0]} (${resultsArray[21].fives[1]}%) | ${resultsArray[21].fives[2]} (${resultsArray[21].fives[3]}%) \nSixes (all | unique): ${resultsArray[21].sixes[0]} (${resultsArray[21].sixes[1]}%) | ${resultsArray[21].sixes[2]} (${resultsArray[21].sixes[3]}%) \nSevens (all | unique): ${resultsArray[21].sevens[0]} (${resultsArray[21].sevens[1]}%) | ${resultsArray[21].sevens[2]} (${resultsArray[21].sevens[3]}%) \nEights (all | unique): ${resultsArray[21].eights[0]} (${resultsArray[21].eights[1]}%) | ${resultsArray[21].eights[2]} (${resultsArray[21].eights[3]}%) \nNines (all | unique): ${resultsArray[21].nines[0]} (${resultsArray[21].nines[1]}%) | ${resultsArray[21].nines[2]} (${resultsArray[21].nines[3]}%)`;
